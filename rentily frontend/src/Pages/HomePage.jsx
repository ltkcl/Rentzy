      ...
      <header className="relative bg-gradient-to-b from-blue-500 to-blue-100 px-6 py-12 md:py-16 flex flex-col items-center text-center overflow-visible">
        <div className="relative z-10 flex flex-col items-center gap-2 mb-8">
          <img
            ...
            alt="Rentzy"
            className="h-16 md:h-20 transform -rotate-2 hover:rotate-0 transition-transform duration-300 ease-out drop-shadow-xl"
          />
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight">
              ...
              <span>
                <img
                  src="/logos/logowithtext.png"
                  alt="Rentzy"
                  className="h-9 inline-block transform -rotate-3 hover:rotate-0 transition-transform duration-300 ease-out drop-shadow-md mb-1 align-middle"
                />
              </span>{" "}
              Works
            </h2>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between gap-12 mb-12">
          <div className="max-w-sm">
            <img
              src="/logos/logowithtext.png"
              alt="Rentzy"
              className="h-10 transform -rotate-3 hover:rotate-0 transition-transform duration-300 ease-out drop-shadow-md mb-6"
            />
